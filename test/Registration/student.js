document.addEventListener('DOMContentLoaded', () => {
    ...
    const amountInput = document.getElementById('full-payment-amount');
    const balance = totalDue - student.paid;
    amountInput.value = balance;

    if (balance <= 0) {
        document.querySelector('.payment-form-section').innerHTML = '<h4>คุณได้ชำระเงินครบถ้วนแล้ว</h4>';
    }
    ...
    form.addEventListener('submit', (e) => {
        ...
        const slip = document.getElementById('full-payment-slip').files[0];
